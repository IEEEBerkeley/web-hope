...
<p>For this lab, please follow <strong>Method A</strong> for your regulator IC. For your USB connectors, you can use the generic USB-A symbol in KiCad, and the generic 16-pin USB-C symbol. You should also add the DigiKey library by following Method B below, regardless of whether there are already KiCad symbols available:</p>
