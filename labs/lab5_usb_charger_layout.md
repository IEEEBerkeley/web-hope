...
<p>Is everything okay for standard manufacturing? The board manufacturer that makes boards for this class is <a href="https://jlcpcb.com/">JLCPCB</a>, and as a result, we need to follow their manufacturing capabilities for our boards to be made. In KiCad we can set up the rules that our design must follow under <code>File &gt; Board Setup</code>. Then click on <code>Design Rules &gt; Constraints</code>, and then fill in the values according to this <a href="https://jlcpcb.com/capabilities/pcb-capabilities">table of capabilities</a>. There is also a subcategory under Design Rules called Net Classes, and you can set different rules for different types of nets (e.g. power should have a thicker minimum width).</p>
...
<p>We've put together a DRC template that we encourage you to use. Please check out the following link and follow the included instructions to <a href="https://docs.google.com/document/d/1XIp4hQyu5kEEh66-nD2Bew6qIBCuiEiuqHCNkp3XYyc/edit?tab=t.0">import the HOPE DRC template</a>.</p>
<blockquote>
<p>While we encourage you to try filling out the constraints from JLCPCB yourself, you can also just make sure your Design Rules match the values in the table below. You should try to understand where these values come from:</p>
</blockquote>
<!-- kg-card-end: markdown-->
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="../assets/lab5/board_setup_new.png" class="kg-image" alt="" loading="lazy" width="2000" height="1197"><figcaption>Design Rule Constraints</figcaption></figure>
<!--kg-card-begin: markdown<h2 id="mechanicalconstraints">Mechanical constraints</h2> -->
...
<h2 id="gerberexport">Gerber Files and Manufacturing</h2>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="../assets/lab5/gebers.png" class="kg-image" alt="" loading="lazy" width="2000" height="1197"><figcaption>Gerber export. Click "Plot" first, then click "Generate Drill Files"</figcaption></figure>
...
<li>Have a fully routed layout that fits in one of the above outlines, <b>including test points</b>
<ul>
...
<li>Run a Design For Manufacturing (DFM) check and show your design passes</li>
</ul>
<hr><!--kg-card-begin: html-->      <div class="linkbox">
<div class="newh2"><a href="https://ieee.berkeley.edu/hope/" style="font-weight: 700;">HOPE Main Page</a></div>
</div>
